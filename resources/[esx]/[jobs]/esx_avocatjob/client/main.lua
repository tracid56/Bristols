    ...
    function(data, menu)
      if data.current.value == 'vehicle_list' then
        ...
        if Config.EnableSocietyOwnedVehicles then
            ...
            local elements = {
              {label = 'Véhicule Intérimaire', value = 'bmm'},
              {label = 'Véhicule Avocat', value = 'bmm'}
            }
            ...
            if Config.EnablePlayerManagement and PlayerData.job ~= nil and
              ...
              table.insert(elements, {label = 'Véhicule Boss', value = 'bmm'})
            end
          ...
          function(data, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_avocat', _U('mechanic'), amount)
              end
            end
          end,
        function(data, menu)
