...
Citizen.CreateThread(function ()
  ...
  ESX.TriggerServerCallback('esx_organisateur:getCategories', function (categories)
    Categories = categories
  end)

  ESX.TriggerServerCallback('esx_organisateur:getVehicles', function (vehicles)
    Vehicles = vehicles
  end)
end)
    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_organisateur:annonce',result)
        ...
        function (data2, menu2)
          if data2.current.value == 'yes' then
            if Config.EnablePlayerManagement then
              ESX.TriggerServerCallback('esx_organisateur:buyVehicleSociety', function (hasEnoughMoney)
              ...
              end, 'organisateur', vehicleData.model)
            else
                ...
                ESX.UI.Menu.Open(
                  ...
                  function (data3, menu3)
                    ...
                    if data3.current.value == 'personnal' then
                      ESX.TriggerServerCallback('esx_organisateur:buyVehicle', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          IsInShopMenu = false
                          ...
                          ESX.Game.SpawnVehicle(vehicleData.model, {
                            ...
                            if Config.EnableOwnedVehicles then
                              TriggerServerEvent('esx_organisateur:setVehicleOwned', vehicleProps)
                            end
                      ...
                      ESX.TriggerServerCallback('esx_organisateur:buyVehicleSociety', function (hasEnoughMoney)
                        if hasEnoughMoney then
                          ...
                          ESX.Game.SpawnVehicle(vehicleData.model, {
                            ...
                            TriggerServerEvent('esx_organisateur:setVehicleOwnedSociety', playerData.job.name, vehicleProps)
...
----------------------------------------------------------------------------------
function OpenMobilecardealerActionsMenu()

	ESX.UI.Menu.CloseAll()

	ESX.UI.Menu.Open(
		'default', GetCurrentResourceName(), 'mobile_cardealer_actions',
		{
      css = 'organisateur',
			title    = 'Organisateur',
			elements = {
        ...
        {label = 'Caméra', value = 'camera'},
				{label = 'Equiper Turbo',  value = 'equipe_turbo'}
			}
		},
		function(data, menu)
					...
					function(data, menu)
						...
						if amount == nil then
							...
							if closestPlayer == -1 or closestDistance > 3.0 then
								...
								TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_organisateur', 'organisateur', amount)
							end
						end
					end,
				function(data, menu)
						...
						if NPCOnJob then
							if NPCTargetDeleterZone then
                 				if CurrentlyTowedVehicle == NPCTargetTowable then
                   					...
                   					TriggerServerEvent('esx_cardealerjob:onNPCJobMissionCompleted')
                   					StopNPCJob()
			...
			if data.current.value == 'object_spawner' then
				...
				ESX.UI.Menu.Open(
					'default', GetCurrentResourceName(), 'mobile_cardealer_actions_spawn',
					{
            css = 'organisateur',
						title    = 'Objets',
						align    = 'top-left',
...
Citizen.CreateThread(function()
    while true do
        ...
        if CurrentAction ~= nil then
            ...
            if IsControlJustReleased(0, 38) and PlayerData.job ~= nil and PlayerData.job.name == 'organisateur' then
                if CurrentAction == 'cardealer_actions_menu' then
                    OpencardealerActionsMenu()
                end
                if CurrentAction == 'cardealer_harvest_menu' then
                    OpencardealerHarvestMenu()
                end
                if CurrentAction == 'boss_actions_menu' then
                	OpenBossActionsMenu()
                end
                if CurrentAction == 'cardealer_craft_menu' then
                    OpencardealerCraftMenu()
                end
                if CurrentAction == 'delete_vehicle' then
                    ...
                    if hash == GetHashKey('flatbed') or hash == GetHashKey('sandking') or hash == GetHashKey('slamvan3') or hash == GetHashKey('forklift') then
                        if Config.MaxInService ~= -1 then
                            TriggerServerEvent('esx_service:disableService', 'organisateur')
                        end
        ...
        if IsControlJustReleased(0, Keys['F6']) and PlayerData.job ~= nil and PlayerData.job.name == 'organisateur' then
            OpenMobilecardealerActionsMenu()
        end
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'reseller',
    {
      ...
      elements = {
        ...
        --{label = 'Vehicules Event',   value = 'shoporga'},
    ...
    function (data, menu)
      ...
      if data.current.value == 'shoporga' then
        OpenShopMenu()
      end
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 3.0 then
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(closestPlayer), 'society_organisateur', _U('car_dealer'), tonumber(data2.value))
              end
            end
          end,
          function (data2, menu)
      ...
      if data.current.value == 'set_vehicle_owner_sell' then
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          TriggerServerEvent('esx_organisateur:sellVehicle', model)

          if Config.EnableOwnedVehicles then
            TriggerServerEvent('esx_organisateur:setVehicleOwnedPlayerId', GetPlayerServerId(closestPlayer), vehicleProps)
        ...
        if closestPlayer == -1 or closestDistance > 3.0 then
          ...
          ESX.TriggerServerCallback('esx:getOtherPlayerData', function (xPlayer)
            ...
            if Config.EnableSocietyOwnedVehicles then
              TriggerServerEvent('esx_organisateur:setVehicleOwnedSociety', xPlayer.job.name, vehicleProps)
              ESX.ShowNotification(_U('vehicle_set_owned', vehicleProps.plate, GetPlayerName(closestPlayer)))
            else
              ESX.ShowNotification(_U('vehicle_sold_to', vehicleProps.plate, GetPlayerName(closestPlayer)))
            end
          ...
          function (data2, menu)
            ...
            if amount == nil then
              ...
              if closestPlayer == -1 or closestDistance > 5.0 then
                ...
                TriggerServerEvent('esx_organisateur:rentVehicle', model, vehicleProps.plate, GetPlayerName(closestPlayer), CurrentVehicleData.price, amount, GetPlayerServerId(closestPlayer))
                ...
                TriggerServerEvent('esx_organisateur:setVehicleForAllPlayers', vehicleProps, Config.Zones.ShopInside.Pos.x, Config.Zones.ShopInside.Pos.y, Config.Zones.ShopInside.Pos.z, 5.0)
              end
            end
          end,
          function (data2, menu)
...
function OpenPersonnalVehicleMenu ()
  ...
  ESX.TriggerServerCallback('esx_organisateur:getPersonnalVehicles', function (vehicles)
    local elements = {}
...
function OpenPopVehicleMenu ()
  ESX.TriggerServerCallback('esx_organisateur:getCommercialVehicles', function (vehicles)
    local elements = {}
...
function OpenRentedVehiclesMenu ()
  ESX.TriggerServerCallback('esx_organisateur:getRentedVehicles', function (vehicles)
    local elements = {}
  ...
  ESX.UI.Menu.Open(
    ...
    function (data, menu)
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBossMenu', 'organisateur', function(data, menu)
          menu.close()
        end)
      end
    end,
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        {label = 'Tenue Concessionaire', value = 'agent_wear'}
      },
    },
    function(data, menu)
      ...
      if data.current.value == 'citizen_wear' then
        ...
        TriggerServerEvent("player:serviceOff", "organisateur")
      ...
      if data.current.value == 'agent_wear' then
        ...
        TriggerServerEvent("player:serviceOn", "organisateur")
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
...
function OpenGetStocksMenu ()
  ESX.TriggerServerCallback('esx_organisateur:getStockItems', function (items)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_organisateur:getStockItem', itemName, count)
            end
          end,
          function (data2, menu2)
            menu2.close()
...
function OpenPutStocksMenu ()
  ESX.TriggerServerCallback('esx_organisateur:getPlayerInventory', function (inventory)
    local elements = {}
        ...
        ESX.UI.Menu.Open(
          ...
          function (data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_organisateur:putStockItems', itemName, count)
            end
...
AddEventHandler('esx:playerLoaded', function (xPlayer)
  ...
  if Config.EnablePlayerManagement then
    if PlayerData.job.name == 'organisateur' then
...
RegisterNetEvent('esx_organisateur:openPersonnalVehicleMenu')
AddEventHandler('esx_organisateur:openPersonnalVehicleMenu', function ()
  OpenPersonnalVehicleMenu()
end)

AddEventHandler('esx_organisateur:hasEnteredMarker', function (zone)
  if zone == 'ShopEntering' then
    if Config.EnablePlayerManagement then
      if PlayerData.job ~= nil and PlayerData.job.name == 'organisateur' then
        CurrentAction     = 'reseller_menu'
        CurrentActionMsg  = _U('shop_menu')
        CurrentActionData = {}
      end
  ...
  if zone == 'BossActions' and Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'organisateur' and PlayerData.job.grade_name == 'boss' then
    CurrentAction     = 'boss_actions_menu'
    CurrentActionMsg  = _U('shop_menu')
    CurrentActionData = {}
  end
...
AddEventHandler('esx_organisateur:hasExitedMarker', function (zone)
...
Citizen.CreateThread(function ()
  ...
  AddTextComponentString('Organisateur')
...
Citizen.CreateThread(function ()
  while true do
    ...
    if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
      ...
      TriggerEvent('esx_organisateur:hasEnteredMarker', currentZone)
    end

    if not isInMarker and HasAlreadyEnteredMarker then
      HasAlreadyEnteredMarker = false
      TriggerEvent('esx_organisateur:hasExitedMarker', LastZone)
    end
  end
end)
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0, Keys['E']) and (GetGameTimer() - GUI.Time) > 300 then
        ...
        if CurrentAction == 'give_back_vehicle' then
          ESX.TriggerServerCallback('esx_organisateur:giveBackVehicle', function (isRentedVehicle)
        ...
        if CurrentAction == 'resell_vehicle' then
          ESX.TriggerServerCallback('esx_organisateur:resellVehicle', function (isOwnedVehicle)
        ...
        while true do
            Citizen.Wait(1)    
                ...
                if (affichenews == true) then
                    ...
                    DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~r~ ORGANISATEUR ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('esx_organisateur:annonce')
AddEventHandler('esx_organisateur:annonce', function(text)
    texteafiche = text
    affichenews = true
...
RegisterNetEvent('esx_organisateur:annoncestop')
AddEventHandler('esx_organisateur:annoncestop', function()
    affichenews = false
    
  end)

  local Despawnpoint = {
    { ['x'] = 1735.388, ['y'] = 3316.853, ['z'] = 41.223 }
  }
