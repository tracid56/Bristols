Locales['fr'] = {
  ...
  -- PNJ
  ['must_in_police'] = 'vous devez être dans un véhicule de police pour commencer la mission',
  ...
  ['drive_search_pass'] = 'conduisez à la recherche de ~y~suspect',
	['customer_found'] = 'vous avez ~g~trouvé~s~ un suspect, conduisez jusqu\'à ce dernier',
	['client_unconcious'] = 'votre suspect est ~r~inconscient~w~. Cherchez-en un autre.',
	['arrive_dest'] = 'vous êtes ~g~arrivé~s~ à destination',
	['take_me_to_near'] = '~w~Amenez le suspect au Commissariat~y~',
	['take_me_to'] = '~w~Amenez le suspect au Commissariat~y~',
	['close_to_client'] = 'vous êtes à proximité du suspect, approchez-vous de lui',
