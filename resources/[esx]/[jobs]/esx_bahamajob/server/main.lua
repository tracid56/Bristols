...
RegisterServerEvent('esx_bahamajob:giveWeapon')
AddEventHandler('esx_bahamajob:giveWeapon', function(weapon, ammo)
  local xPlayer = ESX.GetPlayerFromId(source)
  xPlayer.addWeapon(weapon, ammo)
end)

RegisterServerEvent('esx_bahamajob:removeWeapon')
AddEventHandler('esx_bahamajob:removeWeapon', function(weapon)
  local xPlayer = ESX.GetPlayerFromId(source)
