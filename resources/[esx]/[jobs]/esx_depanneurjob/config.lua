...
Config.Zones = {
	...
	MechanicActions = {
		Pos   = { x = -206.788, y = -1341.589, z = 33.894 },
	...
	Garage = {
		Pos   = { x = 767.681, y = -1318.714, z =  26.275},
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	Craft = {
		Pos   = { x = -227.240, y = -1327.649, z = 29.890 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1,
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -223.715, y = -1290.404, z = 30.295 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -180.019, y = -1287.528, z = 30.295 },
	...
	VehicleDelivery = {
		Pos   = { x = -165.192, y = -1306.153, z = 30.329 },
