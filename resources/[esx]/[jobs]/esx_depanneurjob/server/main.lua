...
RegisterServerEvent('esx_mecanojob:mecano')
AddEventHandler('esx_mecanojob:mecano', function(result)
	...
	for i=1, #xPlayers, 1 do
 		...
 		TriggerClientEvent('esx_breakingnews:mecano', xPlayers[i],mess)
	end
...
AddEventHandler('esx_mecanojob:onNPCJobMissionCompleted', function()
	...
	if societyAccount ~= nil then
	  ...
	  local playerMoney = math.random(0,0)
	  local societyMoney  = math.random(100,100)
