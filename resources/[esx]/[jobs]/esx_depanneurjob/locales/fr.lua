Locales['fr'] = {
  ...
  ['inside_vehicle']            = 'vous ne pouvez pas le faire depuis l’intérieur du véhicule !', 
  ...
  ['player_cannot_hold']        = 'vous n\'avez pas assez de ~y~espace libre~s~ dans votre inventaire !',
