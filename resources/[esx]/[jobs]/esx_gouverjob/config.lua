...
Config.PoliceStations = {
  ...
  LSPD = {
    ...
    AuthorizedWeapons = {
      ...
      { name = 'WEAPON_MARKSMANRIFLE',    price = 0 },
    ...
    AuthorizedVehicles = {
      ...
      { name = 'polp1',   label = 'Véhicule Rapide Intervention' }
    },

    Cloakrooms = {
      { x = 152.227, y = -751.538, z = 241.152 },
    },

    Armories = {
      { x = 118.827, y = -729.269, z = 241.151 },
    },

    Vehicles = {
      {
        Spawner    = { x = -396.286, y = 1102.233, z = 324.843 },
        SpawnPoint = { x = -392.987, y = 1198.069, z = 324.166 },
        Heading    = 0.0,
      }
    },
    ...
    Helicopters = {
      {
        Spawner    = { x = -457.996, y = 1135.339, z = 326.653 },
        SpawnPoint = { x = -454.210, y = 1143.416, z = 326.687 },
        Heading    = 0.0,
      }
    },

    VehicleDeleters = {
      { x = -414.124, y = -1201.947, z = 324.641 },
      { x = -454.210, y = 1143.416, z = 326.687 },
    },

    BossActions = {
      { x = 108.245, y = -744.882, z = 241.152 }
    },
