    ...
    while messagenotfinish do
      ...
      DisplayOnscreenKeyboard(1, "FMMC_MPM_NA", "", "", "", "", "", 30)
        ...
        if (GetOnscreenKeyboardResult()) then
           ...
           TriggerServerEvent('esx_gouverjob:annonce',result)
...
function cleanPlayer(playerPed)
  ...
  ResetPedMovementClipset(playerPed, 0)
   ...
   TriggerServerEvent("player:serviceOff", "gouvernor")
end
...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'security_gouvernor' then
    table.insert(elements, {label = 'Tenue Gouvernement', value = 'commandant_wear'})
  end
  ...
  if Config.EnableNonFreemodePeds then
    ...
    table.insert(elements, {label = 'Tenue Lieutenant', value = 'lieutenant_wear'})
    ...
    ESX.UI.Menu.Open(
      ...
      SetPedComponentVariation(GetPlayerPed(-1), 4, 13, 0, 0)--Jean
      SetPedComponentVariation(GetPlayerPed(-1), 6, 10, 0, 0)--Chaussure
      SetPedComponentVariation(GetPlayerPed(-1), 8, 31, 0, 0)--mattraque  
      SetPedComponentVariation(GetPlayerPed(-1), 7, 10, 2, 1)--cravate      
      SetPedComponentVariation(GetPlayerPed(-1), 11, 29, 0, 0)--Veste(jacket)
      ...
      SetPedComponentVariation(GetPlayerPed(-1), 6, 29, 2, 0)--Chaussure
      SetPedComponentVariation(GetPlayerPed(-1), 8, 38, 0, 2)-- mattraque (shirt)
      SetPedComponentVariation(GetPlayerPed(-1), 7, 22, 0, 1)--cravate          
      SetPedComponentVariation(GetPlayerPed(-1), 10, 7, 0, 0)--Veste
      ...
      if data.current.value == 'bri_wear' then --Ajout de tenue par grades
    ...
    RemoveAllPedWeapons(GetPlayerPed(-1), false)
      ...
      if
        ...
        data.current.value == 'sergeant_chef_wear' or
        data.current.value == 'lieutenant_wear' or
        data.current.value == 'capitaine_wear' or
        data.current.value == 'bullet_wear' or
        data.current.value == 'gilet_wear'
      then
        TriggerServerEvent("player:serviceOn", "gouvernor")
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_gouverjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    if PlayerData.job.grade_name == 'security_gouvernor' then
      table.insert(elements, { label = 'Schafter blindé', value = 'schafter6'})
    end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if action == 'facture' then
                OpenBillingMenu(player)
              end
			  
              if action == 'handcuff' then
                TriggerServerEvent('esx_gouverjob:handcuff', GetPlayerServerId(player))
              elseif action == 'drag' then
                TriggerServerEvent('esx_gouverjob:drag', GetPlayerServerId(player))
              elseif action == 'put_in_vehicle' then
                TriggerServerEvent('esx_gouverjob:putInVehicle', GetPlayerServerId(player))
              elseif action == 'out_the_vehicle' then
                  TriggerServerEvent('esx_gouverjob:OutVehicle', GetPlayerServerId(player))
      ...
      if data.current.value == 'radar_spawner' then
       ...
       if data.current.value == 'camera' then
        TriggerEvent('camera:gouv') 
      end
...
function OpenIdentityCardMenu(player)
	...
	ESX.TriggerServerCallback('esx_gouverjob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_gouverjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_gouvernor', _U('billing'), amount)
        end
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getFineList', function(fines)
        ...
        if Config.EnablePlayerManagement then
          local playerPed        = GetPlayerPed(-1)
            ...
            Citizen.CreateThread(function()
                ...
                TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_gouvernor', 'Amende: ' .. label, amount)
            end)    
        else
...
function ShowPlayerLicense(player)
	...
	ESX.TriggerServerCallback('esx_gouverjob:getOtherPlayerData', function(data)
      ...
      css = 'gouvernement',
			...
			TriggerServerEvent('esx_gouverjob:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_gouverjob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_gouverjob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_gouverjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gouverjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_gouverjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_gouverjob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx:setJob', function(job)
	...
	Citizen.Wait(5000)
	TriggerServerEvent('esx_gouverjob:forceBlip')
end)
...
AddEventHandler('esx_gouverjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_gouverjob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_gouverjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_gouverjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_gouverjob:handcuff')
AddEventHandler('esx_gouverjob:handcuff', function()
...
RegisterNetEvent('esx_gouverjob:drag')
AddEventHandler('esx_gouverjob:drag', function(cop)
...
RegisterNetEvent('esx_gouverjob:putInVehicle')
AddEventHandler('esx_gouverjob:putInVehicle', function()
...
RegisterNetEvent('esx_gouverjob:OutVehicle')
AddEventHandler('esx_gouverjob:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' then
      ...
      for k,v in pairs(Config.PoliceStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' and PlayerData.job.grade_name == 'boss' then
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_gouverjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_gouverjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_gouverjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_gouverjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction ~= nil then
			...
			if IsControlPressed(0, Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' and (GetGameTimer() - GUI.Time) > 150 then
		...
		if IsControlPressed(0, Keys['F6']) and not isDead and PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
RegisterNetEvent('esx_gouverjob:updateBlip')
AddEventHandler('esx_gouverjob:updateBlip', function()
	...
	if PlayerData.job ~= nil and PlayerData.job.name == 'gouvernor' then
		ESX.TriggerServerCallback('esx_society:getOnlinePlayers', function(players)
			for i=1, #players, 1 do
				if players[i].job.name == 'gouvernor' then
					for id = 0, 31 do
...
AddEventHandler('playerSpawned', function(spawn)
	...
	if not hasAlreadyJoined then
		TriggerServerEvent('esx_gouverjob:spawned')
	end
...
AddEventHandler('jail:teleportPlayer', function(amount)
  if IsHandcuffed then
    TriggerEvent('esx_gouverjob:handcuff')
...
local gouv = {x = -429.5257, y = 1109.5, z = 326.710}
local coord1 = {x = -429.5257, y = 1109.5, z = 327.710}
local coord2 = {x = 136.184, y = -761.669, z = 242.151}
...
Citizen.CreateThread(function()
	...
	TriggerServerEvent("esx_gouverjob:addPlayer", playerJob)
    ...
    Citizen.Wait(0)
		...
		if(isNear(coord1)) then
			if(playerJob == "gouvernor") then
				Info("Appuyez sur ~INPUT_CONTEXT~ pour entrer dans votre bureau")
				...
				Info("Appuyez sur ~INPUT_CONTEXT~ pour sonner au Gouvernement")

				if(IsControlJustPressed(1, 38)) then
          TriggerServerEvent("esx_gouverjob:sendSonnette")
          SendNotification("~g~Vous avez sonnez a la porte !")
				end
			end
		end

		if(isNear(coord2)) then
			Info("Appuyez sur ~INPUT_CONTEXT~ pour sortir du Gouvernement")
...
RegisterNetEvent("esx_gouverjob:sendRequest")
AddEventHandler("esx_gouverjob:sendRequest", function(name,id)
	stopRequest = true
	SendNotification("~b~"..name.." ~w~a sonné à la porte du gouvernement !")
	SendNotification("~b~F+LEFTSHIFT ~w~pour ~g~accepter~w~ / ~b~G+LEFTSHIFT ~w~ pour ~r~refuser~w~.")

	stopRequest = false
	while not stopRequest do
		Citizen.Wait(0)

    if (GetLastInputMethod(2) and IsControlJustPressed(1, 23) and IsControlPressed(1, 21)) and not IsPedInAnyVehicle(playerPed, true) then
			TriggerServerEvent("esx_gouverjob:sendStatusToPoeple", id, 1)
			stopRequest = true
		end
      ...
      if (GetLastInputMethod(2) and IsControlJustPressed(1, 47) and IsControlPressed(1, 21)) and not IsPedInAnyVehicle(playerPed, true) then
			TriggerServerEvent("esx_gouverjob:sendStatusToPoeple", id,0)
			stopRequest = true
		end
	end
end)

RegisterNetEvent("esx_gouverjob:sendStatus")
AddEventHandler("esx_gouverjob:sendStatus", function(status)
	if(status == 1) then
      ...
      while true do
          Citizen.Wait(1)    
              ...
              if (affichenews == true) then
                  ...
                  DrawAdvancedTextCNN(0.588, 0.14, 0.005, 0.0028, 0.8, "~r~ GOUVERNEMENT ~d~", 255, 255, 255, 255, 1, 0)
...
RegisterNetEvent('esx_gouverjob:annonce')
AddEventHandler('esx_gouverjob:annonce', function(text)
  texteafiche = text
  affichenews = true
...
RegisterNetEvent('esx_gouverjob:annoncestop')
AddEventHandler('esx_gouverjob:annoncestop', function()
  affichenews = false
