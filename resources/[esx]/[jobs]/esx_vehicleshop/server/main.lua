...
TriggerEvent('esx_phone:registerNumber', 'pdm', _U('dealer_customers'), false, false)
TriggerEvent('esx_society:registerSociety', 'pdm', _U('car_dealer'), 'society_pdm', 'society_pdm', 'society_pdm', {type = 'private'})
...
RegisterServerEvent('esx_vehicleshop:annonce')
AddEventHandler('esx_vehicleshop:annonce', function(result)
  local _source  = source
  local xPlayer  = ESX.GetPlayerFromId(_source)
  ...
  for i=1, #xPlayers, 1 do
    ...
    TriggerClientEvent('esx_vehicleshop:annonce', xPlayers[i],text)
  end
  ...
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    TriggerClientEvent('esx_vehicleshop:annoncestop', xPlayers[i])
  end
      ...
      MySQL.Async.fetchAll(
        ...
        function (result)
          ...
          for i=1, #result, 1 do
            ...
            TriggerEvent('esx_addonaccount:getSharedAccount', 'society_pdm', function(account)
