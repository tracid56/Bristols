...
RegisterServerEvent('esx_journaliste:journaliste')
AddEventHandler('esx_journaliste:journaliste', function(result)
	...
	for i=1, #xPlayers, 1 do
 		...
 		TriggerClientEvent('esx_breakingnews:journaliste', xPlayers[i],mess)
	end
