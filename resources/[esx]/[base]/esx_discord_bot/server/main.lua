...
AddEventHandler("esx:giveitemalert", function(name,nametarget,itemname,amount)
   if(settings.LogItemTransfer)then
    sendToDiscord(_U('server_item_transfer'),name.." ".._('user_gives_to')..""..amount .." "..itemname.." à "..nametarget.."",Config.orange)
   end
...
AddEventHandler("esx:givemoneyalert", function(name,nametarget,amount)
  if(settings.LogMoneyTransfer)then
    sendToDiscord(_U('server_money_transfer'),name.." ".._('user_gives_to')..""..amount.." dollars à "..nametarget.."",Config.orange)
  end
...
AddEventHandler("esx:givemoneybankalert", function(name,nametarget,amount)
  if(settings.LogMoneyBankTransfert)then
   sendToDiscord(_U('server_moneybank_transfer'),name.." ".. _('user_gives_to')..""..amount.." dollars à "..nametarget.."",Config.orange)
  end
...
AddEventHandler("esx:giveweaponalert", function(name,nametarget,weaponlabel)
  if(settings.LogWeaponTransfer)then
    sendToDiscord(_U('server_weapon_transfer'),name.." ".._('user_gives_to').."un/une "..weaponlabel.." à "..nametarget.."",Config.orange)
  end
...
RegisterServerEvent("esx:holdupmagbot")
AddEventHandler("esx:holdupmagbot", function(name,robb)
  sendToDiscord(_U('bragage'),name.."".._('holdupmagbot').."".. robb .."",Config.orange)

end)

RegisterServerEvent("esx:holdupmagbot2")
AddEventHandler("esx:holdupmagbot2", function(name,robb)
  sendToDiscord(_U('bragage'),name.."".._('holdupmagbot2').."".. robb .."",Config.orange)

end)

RegisterServerEvent("esx:holdupmagbot3")
AddEventHandler("esx:holdupmagbot3", function(name,robb,amount)
  sendToDiscord(_U('bragage'),name.."".._('holdupmagbot3').."".. robb .." et a gagner "..amount.."$",Config.orange)
...
AddEventHandler("esx:enterblacklistedcar", function(model)
   ...
   sendToDiscord(_U('server_blacklistedvehicle'),xPlayer.name.." ".._('user_entered_in').."un/une ".. model ,Config.red)
...
AddEventHandler("esx:enterpolicecar", function(model)
 	 local xPlayer = ESX.GetPlayerFromId(source)
 	 sendToDiscord(_U('server_policecar'),xPlayer.name.." ".._('user_entered_in').."un/une ".. model , Config.blue)
...
AddEventHandler("esx:jackingcar", function(model)
   local xPlayer = ESX.GetPlayerFromId(source)
   sendToDiscord(_U('server_carjacking'),xPlayer.name.." ".._('user_carjacking').."un/une ".. model,Config.purple)
