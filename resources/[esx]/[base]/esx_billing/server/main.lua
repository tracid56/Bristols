				...
				if xPlayer2.source == playerId then
						...
						MySQL.Async.execute(
							...
							function(rowsChanged)
								TriggerClientEvent('esx:showNotification', xPlayer2.source, _U('received_invoice') .. amount)
							end
						)
		...
		function(result)
			...
			if targetType == 'player' then
				...
				if foundPlayer ~= nil then
					...
					elseif xPlayer.get('bank') - amount >= -200000 then
						...
						MySQL.Async.execute(
							...
							function(rowsChanged)
								...
								TriggerClientEvent('esx:showNotification', xPlayer.source, _U('paid_invoice') .. amount .. ' ~w~avec votre carte bancaire')
								TriggerClientEvent('esx:showNotification', foundPlayer.source, _U('received_payment') .. amount)
