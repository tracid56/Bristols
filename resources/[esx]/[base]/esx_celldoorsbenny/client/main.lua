...
Citizen.CreateThread(function()
	...
	ESX.TriggerServerCallback('esx_celldoorsbenny:getDoorInfo', function(doorInfo, count)
			...
			if distance < maxDistance then
				...
				if IsControlJustReleased(0, Keys['E']) then
					if isAuthorized then
						...
						TriggerServerEvent('esx_celldoorsbenny:updateState', i, doorID.locked) -- Broadcast new state of the door to everyone
					end
				end
			end
		end
...
RegisterNetEvent('esx_celldoorsbenny:setState')
AddEventHandler('esx_celldoorsbenny:setState', function(doorID, state)
