...
Config.DoorList = {
	...
	{
		objName = 'v_ilev_ph_cellgate',
		objCoords  = {x = 462.704, y = -1001.92, z = 24.914},
	...
	--
	{
		...
		objCoords  = {x = 470.435, y = -994.290, z = 24.914},
		textCoords = {x = 470.435, y = -994.290, z = 25.064},
		authorizedJobs = { 'police' },
		locked = true,
		distance = 2
	},
	...
	{
		objName = 'v_ilev_ph_gendoor006',
		objCoords  = {x = 469.952, y = -987.649, z = 24.914},
		textCoords = {x = 469.952, y = -987.649, z = 25.064},
		authorizedJobs = { 'police' },
		locked = true,
		distance = 2
	},
	...
	{
		objName = 'v_ilev_ph_gendoor006',
		objCoords  = {x = 477.721, y = -987.283, z = 24.914},
		textCoords = {x = 477.721, y = -987.283, z = 25.064},
		authorizedJobs = { 'police' },
		locked = true,
		distance = 2
	},
	...
	{
		objName = 'v_ilev_ph_gendoor006',
		objCoords  = {x = 468.012, y = -992.803, z = 24.914},
		textCoords = {x = 468.012, y = -992.803, z = 25.064},
		authorizedJobs = { 'police' },
		locked = true,
		distance = 2
	},
