...
local bankMenu	= true
local banks = {
	{name="Banque Principal", id=108, x=241.727, y=220.706, z=106.286, principal = true}
}	
...
local atms = {
	...
	{name="ATM", id=277, x=-1391.0042724609, y=-590.32708740234, z=30.319570541382},-----bahamas
	{name="ATM", id=277, x=-37.702377319336, y=-1114.8610839844, z=26.436586380005},-----PDM
