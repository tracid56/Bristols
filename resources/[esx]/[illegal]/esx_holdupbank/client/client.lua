...
function Braquagebank()
	Citizen.CreateThread(function()
    while messagenotfinish do
    		Citizen.Wait(1)

			local result = 'Braquage de banque en cours, Attention !'
			messagenotfinish = false
			TriggerServerEvent('esx_holdupbank:braquagebank',result)
