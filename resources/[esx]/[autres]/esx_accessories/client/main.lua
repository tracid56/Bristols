        ...
        ESX.UI.Menu.Open(
            ...
            function(data, menu)
                ...
                if data.current.value == 'yes' then
                    ESX.TriggerServerCallback('esx_accessories:buy', function(hasEnoughMoney)
...
RegisterNetEvent('NB:openMenuAccessoire')
AddEventHandler('NB:openMenuAccessoire', function()
	OpenAccessoryMenu()
end)
