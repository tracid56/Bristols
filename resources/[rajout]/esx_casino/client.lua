...
function SlotMenu()
  ClearMenu()
  Menu.addTitle("Cash Machine")
  Menu.addButton("~h~Spin","Spin",nil)
  Menu.addButton("Plus de cash","Plus",nil) 
  Menu.addButton("Moins de cash","Minus",nil) 
end
function _NIL()
	return true
end
		...
		for k,v in ipairs(moneymachine_slot) do
			if(Vdist(v.x, v.y, v.z, pos.x, pos.y, pos.z) < 20.0)then
				...
				if(Vdist(v.x, v.y, v.z, pos.x, pos.y, pos.z) < 1.0)then
					DisplayHelpText("Appuyez sur ~INPUT_CONTEXT~  ~y~pour jouer")
