...
var goodAnswer = [];
var questionUsed = [];
var nbQuestionToAnswer = 5; // don't forget to change the progress bar max value in html
var nbAnswerNeeded = 3; // out of nbQuestionToAnswer
var nbPossibleQuestions = 5; // number of questions in database questions.js
var lastClick = 0;
...
$(".btnQuestion").click(function(){
    $.post('http://esx_driveavion/question', JSON.stringify({}));
});
$(".btnClose").click(function(){
    $.post('http://esx_driveavion/close', JSON.stringify({}));
});
$(".btnKick").click(function(){
    $.post('http://esx_driveavion/kick', JSON.stringify({}));
});
