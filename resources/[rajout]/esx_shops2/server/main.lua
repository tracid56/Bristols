...
RegisterServerEvent('esx_shops2:buyItem')
AddEventHandler('esx_shops2:buyItem', function(itemType, itemName, price)
...
ESX.RegisterServerCallback('esx_shops2:requestDBItems', function(source, cb)
