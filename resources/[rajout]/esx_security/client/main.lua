...
function OpenCloakroomMenu()
  ...
  if PlayerData.job.grade_name == 'officer' then
    table.insert(elements, {label = _U('brigadier_wear'), value = 'brigadier_wear'})
  end
  ...
  if PlayerData.job.grade_name == 'lieutenant' then
    table.insert(elements, {label = _U('sergeantchef_wear'), value = 'sergeant_wear'})
  end
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      SetPedComponentVariation(GetPlayerPed(-1), 3, 37, 0, 0)--
      SetPedComponentVariation(GetPlayerPed(-1), 6, 61, 0, 0)--chaussures/shoes
      SetPedComponentVariation(GetPlayerPed(-1), 8, 58, 0, 0)--mattraque (shirt)
      SetPedComponentVariation(GetPlayerPed(-1), 11, 13, 0, 0)--veste/jacket
      SetPedComponentVariation(GetPlayerPed(-1), 7, 38, 0, 1)
      SetPedPropIndex(GetPlayerPed(-1), 2, 2, 0, 1) --Oreillete
      SetPedPropIndex(GetPlayerPed(-1), 1, 1, 0, 0) -- lunette

          end
        end)
      end

      if data.current.value == 'brigadier_wear' then
        TriggerServerEvent("player:serviceOn", "securite")
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 0 then
      SetPedComponentVariation(GetPlayerPed(-1), 9, 0, 0, 2)   -- retrait parballes du swat
      ...
      if data.current.value == 'sergeantchef_wear' then
        TriggerServerEvent("player:serviceOn", "securite")
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 0 then
      SetPedComponentVariation(GetPlayerPed(-1), 9, 0, 0, 2)   -- retrait parballes du swat
      ...
      if data.current.value == 'veste_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 0 then SetPedComponentVariation(GetPlayerPed(-1), 9, 4, 0, 2)  --Bulletproof jacket
      ...
      if data.current.value == 'veste_wear' then
        ESX.TriggerServerCallback('esx_skin:getPlayerSkin', function(skin, jobSkin)
          if skin.sex == 1 then
            SetPedComponentVariation(GetPlayerPed(-1), 9, 6, 0, 2)
        SetPedArmour(GetPlayerPed(-1), 100) -- Ajout armure
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_security:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpenVehicleSpawnerMenu(station, partNum)
  ...
  if Config.EnableSocietyOwnedVehicles then
    ...
    -- table.insert(elements, { label = 'Vélo', value = 'policebike' })
    table.insert(elements, { label = 'Baller Blindée', value = 'baller5' })
    table.insert(elements, { label = 'Schafter Blindée', value = 'schafter5' })

    if PlayerData.job.grade_name == 'boss' then
      table.insert(elements, { label = 'Kuruma Blindée', value = 'kuruma2' })
    end
        ...
        ESX.UI.Menu.Open(
			'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
              ...
              {label = 'Retirer une license',            value = 'license'},
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_security:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_security:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_security:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                  TriggerServerEvent('esx_security:OutVehicle', GetPlayerServerId(player))
              end
              ...
              if data2.current.value == 'license' then
                ShowPlayerLicense(closestPlayer)Menu(player)
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_security:getOtherPlayerData', function(data)
      ...
      if data.job.grade_label ~= nil and  data.job.grade_label ~= '' then
        jobLabel = 'Métiers : ' .. data.job.label .. ' ' .. data.job.grade_label
      else
        jobLabel = 'Métiers : ' .. data.job.label
      end
...
function ShowPlayerLicense(player)
  ...
  ESX.TriggerServerCallback('esx_security:getOtherPlayerData', function(data)
    ...
    function(data, menu)
      ...
      TriggerServerEvent('esx_security:message', GetPlayerServerId(player), _U('license_revoked', data.current.label))
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_security:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_securite', _U('billing'), amount)
        end
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_security:getVehicleInfos', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_security:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_security:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_security:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_security:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_security:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_security:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_security:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_security:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_security:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_security:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_security:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_security:hasEnteredEntityZone', function(entity)
...
AddEventHandler('esx_security:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_security:handcuff')
AddEventHandler('esx_security:handcuff', function()
...
RegisterNetEvent('esx_security:drag')
AddEventHandler('esx_security:drag', function(cop)
...
RegisterNetEvent('esx_security:putInVehicle')
AddEventHandler('esx_security:putInVehicle', function()
...
RegisterNetEvent('esx_security:OutVehicle')
AddEventHandler('esx_security:OutVehicle', function(t)
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'securite' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_security:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_security:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_security:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_security:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if IsControlPressed(0,  Keys["F6"]) and PlayerData.job ~= nil and PlayerData.job.name == 'securite' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'police_actions') and (GetGameTimer() - GUI.Time) > 150 then
...
AddEventHandler('jail:teleportPlayer', function(amount)
  if IsHandcuffed then
    TriggerEvent('esx_security:handcuff')
    ...
    Citizen.CreateThread(function()
      while (amount > 0) do
        if amount == 240 then
          TriggerEvent('chatMessage', '^4 Prison', {0,0,0}, "Temps restant : ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 180 then
          TriggerEvent('chatMessage', '^4 Prison', {0,0,0}, "Temps restant : ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 120 then
          TriggerEvent('chatMessage', '^4 Prison', {0,0,0}, "Temps restant : ^1".. (tonumber(amount)/60) .." minutes !")
        elseif amount == 60 then
          TriggerEvent('chatMessage', '^4 Prison', {0,0,0}, "Temps restant : ^1".. (tonumber(amount)/60) .." minute !")
        else
        ...
        if (GetDistanceBetweenCoords(LastPosX, LastPosY, LastPosZ, 1680.06994628906,2512.80004882813,46.2684020996094, true) > 100.0001) then
            SetEntityCoords(GetPlayerPed(-1), tonumber("1680.07"), tonumber("2512.8"), tonumber("45.4649"))
          	TriggerEvent('chatMessage', '^4 Prison', {0,0,0}, "On ne s'échappe pas de la prison comme ça !")
        end
        Citizen.Wait(1000)
        amount = amount - 1
    ...
    TriggerEvent('chatMessage', source,'^4 Prison', {0,0,0}, "Le Prisonnier doit être menotté !")
  end
end)