...
local wayPoints1 = {
  {
    num=0, 
    text=[[<p>Je m'appelle Jason Junior, fils de Jason Voorhees. Je suis un rescapé de North Yankton moi aussi.</p>
    <p>Tous ces médicaments qu'on m'a donné là-bas me rendent nerveux, et agressif.</p>
    <p>Je suis malade, je ne veux contaminer aucun innocent.</p>
    <p>Je reste dans ma belle forêt. Ma forêt que vous détruisez chaque jour.</p>
    <p>J'ai tué tous les chasseurs qui sont venus détruire la nature, ma famille, les animaux.</p>
    <p>Tu veux être le prochain ?</p>
    <p>Alors fuis. Ne reviens jamais ici.</p>
    <p>Ne touche plus à la nature.</p>
    <p>FUIS !</p>
    ]],
    x=-1451.4836,
    y=4571.7314, 
