Locales['fr'] = {
  ...
  -- Commands
  ['setjob'] = 'assigner un métier',
  ['setfaction'] = 'assigner une faction',
  ['id_param'] = 'identification du joueur',
  ['setjob_param2'] = 'le travail que vous souhaitez assigner',
  ['setfaction_param2'] = 'la faction que vous souhaitez assigner',
  ['setjob_param3'] = 'le niveau d\'emploi',
  ['setfaction_param3'] = 'le niveau de grade',
  ...
  ['weapon_heavysniper_mk2'] = 'fusil de sniper lourd Mk II',
