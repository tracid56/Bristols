...
local wayPoints1 = {
  {
    num=0, 
    text=[[<p>1,2,3 soleil</p>

    <p>AAVTSBXRDHJZYMACEGGTFIKOQUWW</p>
    <p>WFESSBZXTFDYBEGHHIOONNAZKLDMO</p>
    <p>HJJNZWIKPQRRSADDHOSWZRRKJJGEFFG</p>
    <p>EBBXLXLXLLYIYIYCCMPQPQPQPQMMNN</p>
    <p>CCUVTUVVTUUVT</p>
    ]],
    x=3861.6940,
    y=-4959.0405, 
