...
local wayPoints1 = {
  {
    ...
    <p>La nuit précède le matin à North Yankton.</p>
    <p>Et pourtant les nuits sont éclairées.</p>
    <p>Tentons de rétablir un équilibre.</p> 
    <p>Tant pour notre foi que notre détermination.</p>
    <p>Radieux est notre soleil.</p>
    <p>Eternelle est notre neige.</p>
    <p>Prions pour accomplir notre projet.</p>
    ]],
    x=3242.4047,
    y=-4649.3671, 
    z=115.2844,
