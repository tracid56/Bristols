...
AddEventHandler('es_admin:quick', function(t, target)
	...
	if t == "crash" then 
		Citizen.Trace("Vous avez été crash par un admin\n")
	...
	if t == "noclip" then
		...
		TriggerEvent("chatMessage", "SYSTEM", {255, 0, 0}, "Noclip " .. msg)
	end
	if t == "freeze" then
...
AddEventHandler('es_admin:givePosition', function()
	...
	TriggerEvent('chatMessage', 'SYSTEM', {255, 0, 0}, 'Position sauvegardée dans le fichier')
end)
